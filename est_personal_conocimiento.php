...
$page_title = 'Estadística Personal-Conocimientos';
require_once('includes/load.php');

$user = current_user();
$nivel_user = $user['user_level'];
$solicitudes = persConocimiento();
  ...
  <div id="prueba">
    <center>
      <?php if ((int)$_GET['id'] == 1) : ?>
        <h3 style="margin-top: 10px; color: #3a3d44;">Estadística de Personal (Por Área del Conocimiento)</h2>
        <?php endif; ?>        
              ...
              <script>
                ...
                const myChart = new Chart(ctx, {
                  ...
                  data: {
                    ...
                    datasets: [{
                      label: 'Personal por Área del Conocimiento',
                      data: yValues,
                      backgroundColor: [
              ...
              <table class="table table-bordered table-striped">
                <thead class="thead-purple">
                  <tr style="height: 10px;">
                    <th class="text-center" style="width: 70%;">Área del Conocimiento</th>
