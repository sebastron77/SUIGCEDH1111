        ...
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                <strong>
                    ...
                    <span>Registro de Atención/Seguimiento   <?php echo $e_detalle['folio'] ?></span>
                </strong>
            </div>
            ...
            <div class="panel-body">
                ...
                <a href="atencion_seguimiento.php?anio=<?php echo $e_detalle['ejercicio'] ?>" class="btn btn-md btn-success" data-toggle="tooltip" title="Regresar">
                    Regresar
                </a>
            </div>
        </div>
