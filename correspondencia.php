...
<a href="solicitudes_correspondencia_presidencia.php" class="btn btn-info">Regresar a Área</a><br><br>
				...
				<div class="panel-heading clearfix">
					<div class="col-md-10">
							<strong>
								...
								<span>Correspondencia - Oficialia de partes <?php echo $ejercicio ?></span>
							</strong>
					</div>
					<div class="col-md-2">
...
?>
                    ...
                    <a href="add_correspondencia.php?a=<?php echo $area_ingreso ?>" style="margin-left: 10px" class="btn btn-info pull-right">Agregar Correspondencia</a>
                <?php endif; ?>						
				</div>
			</div>
		</div>
                ...
                <table class="datatable table table-bordered table-striped">
                    <thead class="thead-purple">
                        <tr>
                            ...
                            <th style="width: 3%;">Fecha Recibido</th>
                    ...
                    <tbody>
                        <?php foreach ($all_correspondencia as $a_correspondencia) : ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo date("d-m-Y", strtotime(remove_junk(ucwords($a_correspondencia['fecha_recibido'])))) ?></td>
                                <td><?php echo (remove_junk(ucwords(empty($a_correspondencia['fecha_espera_respuesta'])))==1?'Sin Fecha':date("d-m-Y", strtotime(remove_junk(ucwords(($a_correspondencia['fecha_espera_respuesta'])))))) ?></td>
