...
$page_title = 'Agregar Correspondencia Externa Enviada';
...
if (isset($_POST['add_env_correspondencia'])) {
    ...
    if (empty($errors)) {
		...
		$query .= ") VALUES (";
		$query .= " '{$folio}','{$num_oficio}','{$fecha_oficio}','{$asunto}','{$medio_entrega}','{$tipo_accion}','{$nombre_institucion}','{$cargo_destinatario}','{$nombre_destinatario}','{$observaciones}','{$area_ingreso}',NOW() ,'{$id_user}'";
		if ($name != ''){
			$query .= ", '{$name}' ";
		}
		$query .= ")";
echo $query;
        ...
        if ($db->query($query) && $db->query($query2)) {
            ...
            redirect('env_correspondencia_externa.php?a='.$area_ingreso, false);
        } else {
            //failed
        ...
        redirect('env_correspondencia_externa.phpa?a={$area_ingreso}', false);
    }
}
?>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <strong>
                ...
                <span>Agregar correspondencia Externa</span>
            </strong>
        </div>
        
        <div class="panel-body">
            <form method="post" action="add_env_correspondencia_externa.php?a=<?php echo $area_ingreso?>" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="num_oficio">No. Oficio</label>
                            <input type="text" class="form-control" name="num_oficio" required>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="fecha_oficio" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
				 ...
				 <div class="panel-heading">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="cargo_destinatario" required>
                        </div>
                    </div>
                ...
                <div class="form-group clearfix">
                    <a href="env_correspondencia_externa.php?a=<?php echo $area_ingreso?>" class="btn btn-md btn-success" data-toggle="tooltip" title="Regresar">
                        Regresar
                    </a>
