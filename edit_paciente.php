...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE paciente SET nombre='{$nombre}', paterno='{$paterno}', materno='{$materno}', genero='{$genero}', edad='{$edad}',
                        ...
                        ocupacion='{$ocupacion}', discapacidad='{$discapacidad}',  grupo_vulnerable='{$grupo_vulnerable}', leer_escribir='{$leer_escribir}',
					 ...
					 <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="tipo_expediente" name="tipo_expediente">
									...
									<option <?php if ($e_detalle['tipo_expediente'] == 'N') echo 'selected="selected"'; ?> value="N">Sin Expediente</option>
                                </select>
                            </div>
                        </div>
						<div class="col-md-4">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="paterno" value="<?php echo $e_detalle['paterno'] ?>" required>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" min="1" max="130" name="edad" value="<?php echo $e_detalle['edad'] ?>" required>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
