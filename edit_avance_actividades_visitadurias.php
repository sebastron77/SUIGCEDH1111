...
$inticadores_pat = find_all_pat_area($e_detalle['id_area'],'rel_accion_atencion');
$area_informe = find_by_id('area', $e_detalle['id_area'], 'id_area');
?>
<?php


if (isset($_POST['edit_avance_actividades_visitadurias'])) {
	...
	for ($i = 0; $i < sizeof($id_cat_tipo_atencion); $i = $i + 1) {
					...
					redirect('avance_actividades_visitadurias.php?a='.$e_detalle['id_area'], false);
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <strong>
                ...
                <span>Edición de Avances <?php echo $area_informe['nombre_area'];?> <?php echo $e_detalle['folio']?></span>
            </strong>
        </div>
        <div class="panel-body">
            <form method="post" action="edit_avance_actividades_visitadurias.php?id=<?php echo $e_detalle['id_atencion_seguimiento']?>" >
    <div class="row">
            <div class="col-md-6">
...
<?php if ($tipo['visitadurias']==='1') : ?>
                ...
                <div class="form-group clearfix">
                    ...
                    <button type="submit" name="edit_avance_actividades_visitadurias" class="btn btn-primary" value="subir">Guardar</button>
                </div>
            </form>
        </div>
    </div>
