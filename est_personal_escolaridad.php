...
$page_title = 'Estadística Personal-Escolaridad';
require_once('includes/load.php');

$user = current_user();
$nivel_user = $user['user_level'];
$solicitudes = persEscolaridad();
  ...
  <div id="prueba">
    <center>
      <?php if ((int)$_GET['id'] == 1) : ?>
        <h3 style="margin-top: 10px; color: #3a3d44;">Estadística de Personal (Por Escolaridad)</h2>
        <?php endif; ?>        
              ...
              <script>
                ...
                const myChart = new Chart(ctx, {
                  ...
                  data: {
                    ...
                    datasets: [{
                      label: 'Personal por Escolaridad',
                      data: yValues,
                      backgroundColor: [
              ...
              <table class="table table-bordered table-striped">
                <thead class="thead-purple">
                  <tr style="height: 10px;">
                    <th class="text-center" style="width: 70%;">Escolaridad</th>
