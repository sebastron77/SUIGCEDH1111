...
$page_title = 'Estadística Personal-Género';
require_once('includes/load.php');

$user = current_user();
$nivel_user = $user['user_level'];
$solicitudes = persEstadistica('cat_genero','id_cat_gen', 'descripcion');
  ...
  <div id="prueba">
    <center>
      <?php if ((int)$_GET['id'] == 1) : ?>
        <h3 style="margin-top: 10px; color: #3a3d44;">Estadística de Personal (Por género)</h2>
        <?php endif; ?>        
