...
$page_title = 'Estadística Personal-Carrera';
require_once('includes/load.php');

$user = current_user();
$nivel_user = $user['user_level'];
$solicitudes = persCarrera();
  ...
  <div id="prueba">
    <center>
      <?php if ((int)$_GET['id'] == 1) : ?>
        <h3 style="margin-top: 10px; color: #3a3d44;">Estadística de Personal (Por Carrera)</h2>
        <?php endif; ?>        
              ...
              <table class="table table-bordered table-striped">
                <thead class="thead-purple">
                  <tr style="height: 10px;">
                    <th class="text-center" style="width: 70%;">Nombre Carrera</th>
