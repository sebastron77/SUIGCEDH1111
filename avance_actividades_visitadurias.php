...
$page_title = 'Registro de Avance Actividades Visitadurias';
...
$all_atencion_seguimiento = find_all_atencion_seguimiento($area);
...
<script type="text/javascript">	
 function changueAnio(anio){
	 //alert(anio);
	 window.open("avance_actividades_visitadurias.php?anio="+anio,"_self");	 
 }
</script>
				...
				<div class="panel-heading clearfix">
					<div class="col-md-10">
							<strong>
								...
								<span>Avance Actividades Visitadurias <?php echo $ejercicio ?></span>
							</strong>
					</div>
					<div class="col-md-2">
						<div class="form-group" >
						 ...
						 <?php if (($nivel <=2) || ($nivel == 5) ) : ?>
							<a href="add_avance_actividades_visitadurias.php?a=<?php echo  $area;?>" style="margin-left: 10px;margin-right: 10px" class="btn btn-info pull-right">Agregar Registro</a>
						<?php endif; ?>
				...
				?>                     
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
									<a href="ver_info_avance_actividades_visitadurias.php?id=<?php echo (int) $inventario_archivos['id_atencion_seguimiento']; ?>" class="btn btn-md btn-info" data-toggle="tooltip" title="Ver información">
                                        <img src="medios/ver_info.png" style="width: 16px; border-radius: 15%; margin-right: -2px;">
                                    </a>&nbsp;
									<?php if (($nivel <= 2) || ($nivel == 5) ) : ?>
                                    <a href="edit_avance_actividades_visitadurias.php?id=<?php echo (int)$inventario_archivos['id_atencion_seguimiento']; ?>" class="btn btn-warning btn-md" title="Editar" data-toggle="tooltip">
