...
$page_title = 'Estadística Personal-Tipo Integrante';
require_once('includes/load.php');

$user = current_user();
$nivel_user = $user['user_level'];
$solicitudes = persEstadistica('cat_tipo_integrante','id_tipo_integrante', 'descripcion');
  ...
  <div id="prueba">
    <center>
      <?php if ((int)$_GET['id'] == 1) : ?>
        <h3 style="margin-top: 10px; color: #3a3d44;">Estadística de Personal (Por Tipo Integrante)</h2>
        <?php endif; ?>        
              ...
              <script>
                ...
                const myChart = new Chart(ctx, {
                  ...
                  data: {
                    ...
                    datasets: [{
                      label: 'Personal por Tipo Integrante',
                      data: yValues,
                      backgroundColor: [
              ...
              <table class="table table-bordered table-striped">
                <thead class="thead-purple">
                  <tr style="height: 10px;">
                    <th class="text-center" style="width: 70%;">Tipo Integrante</th>
