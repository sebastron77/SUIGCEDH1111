...
$page_title = 'Editar Actividad Especial de la Secretaría Técnica';
 ...
 if($name != '') {
	 $query .= ", documento= '{$name}'";
        ...
        if ($result && $db->affected_rows() === 1) {
                ...
                redirect('edit_actividad_especial_st.php?id='.id_actividades_especiales_areas, false);
            }
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <strong>
                ...
                <span>Editar Actividad Especial de la Secretaría Técnica <?php echo $actividades['folio']; ?></span>
            </strong>
        </div>
        <div class="panel-body">
            <form method="post" action="edit_actividad_especial_st.php?id=<?php echo (int)$actividades['id_actividades_especiales_areas']; ?>" enctype="multipart/form-data" >
                <div class="row">
                    <div class="col-md-3">
