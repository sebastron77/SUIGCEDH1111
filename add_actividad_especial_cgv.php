...
$page_title = 'Agregar Actividad Especial de la Coordinación General de Visitadurias';
...
if (isset($_POST['add_actividad'])) {
    ...
    if (empty($errors)) {
		...
		if (copy($source, $carpeta.'/index.php')) {
            ...
            $query .= ") VALUES (";
            $query .= " '{$folio}',21,'{$fecha_actividad}','{$tema_actividad}','{$quien_atendio}','{$descripcion}','{$name}','{$id_indicadores_pat}','{$id_user}',NOW()); ";
            ...
            if ($db->query($query) && $db->query($query2)) {
                ...
                redirect('add_actividad_especial_cgv.php', false);
            }
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <strong>
                ...
                <span>Agregar Actividad Especial de la Coordinación General de Visitadurias</span>
            </strong>
        </div>
        <div class="panel-body">
            <form method="post" action="add_actividad_especial_cgv.php" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-3">
