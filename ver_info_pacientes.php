...
if ($nivel_user == 7 || $nivel_user == 53) {
	insertAccion($user['id_user'], '"' . $user['username'] . '" Despleglo '.$page_title.' '.remove_junk(ucwords($e_detalle['nombre'] . " " . $e_detalle['paterno'] . " " . $e_detalle['materno'])), 5);
}
?>
        ...
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                <strong>
                    ...
                    <span>Información completa del Paciente:
