                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control form-select" name="id_indicadores_pat" >
                                ...
                                <?php foreach ($inticadores_pat as $datos) : ?>
                                    <option <?php if ($entrevistas['id_indicadores_pat'] == $datos['id_indicadores_pat']) echo 'selected="selected"'; ?>  value="<?php echo $datos['id_indicadores_pat']; ?>"><?php echo ucwords($datos['definicion_indicador']); ?></option>									
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
