...
$page_title = 'Estadística Estado Procesal Quejas';
require_once('includes/load.php');

$user = current_user();
$nivel_user = $user['user_level'];
$year = isset($_GET['id']) ? $_GET['id'] : '0';
$areas = resolucion_estQ($year);
...
<div class="panel-body">
  <center>
    ...
    <div id="prueba">
      ...
      <center>
        <h3 style="margin-top: 10px; color: #3a3d44;">Estadística de Quejas <?php echo ($year > 0?$year:'')?> (Por Tipo Resolución )</h3><br>
      </center>
        ...
        <div style="width:45%; float:left;">
          ...
          <script>
            ...
            const mPresentacion = new Chart(ctx5, {
              type: 'bar',
              data: {
                labels: [<?php foreach ($areas as $med_pres) : ?> '<?php echo $med_pres['nombre_resolucion']; ?>', <?php endforeach; ?>],
                datasets: [{
                  label: '',
                  data: yValues,
                  backgroundColor: [
          ...
          <table class="table table-bordered table-striped" style='font-family: "Montserrat", sans-serif; font-size: 14px;'>
            ...
            <tbody style="background: white;">
			  ...
			  foreach ($areas as $datos) : ?>
                <tr>
                  <td>
                    <?php echo remove_junk(ucwords($datos['nombre_resolucion'])) ?>
                  </td>
                  <td>
