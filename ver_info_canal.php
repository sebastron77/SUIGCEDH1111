                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if (!$datos['acuerdo_adjunto'] == "") { ?>
                                            <a target="_blank" href="uploads/orientacioncanalizacion/canalizacion/<?php echo $resultado . '/Acuerdos/' . $datos['acuerdo_adjunto']; ?>" title="Ver Acuerdo">
                                        ...
                                        <?php if (!$datos['acuerdo_adjunto_publico'] == "") { ?>
                                            &nbsp;&nbsp;&nbsp;
                                            <a target="_blank" href="uploads/orientacioncanalizacion/canalizacion/<?php echo $$resultado . '/Acuerdos/' . $datos['acuerdo_adjunto_publico']; ?>" title="Ver Versión Publica del Acuerdo">
