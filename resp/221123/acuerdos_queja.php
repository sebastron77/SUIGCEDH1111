...
if (isset($_POST['acuerdo_queja'])) {
    ...
    if (empty($errors)) {
        ...
        $interno = remove_junk($db->escape($_POST['interno']));
        ...
        $query = "INSERT INTO rel_queja_acuerdos ( id_queja_date, tipo_acuerdo,fecha_acuerdo,acuerdo_adjunto,acuerdo_adjunto_publico,sintesis_documento,interno,publico,user_creador,fecha_alta) 
                    VALUES ({$id},'{$tipo_acuerdo}','{$fecha_acuerdo}','{$name}','{$name_publico}','{$sintesis_documento}',{$interno},{$publico},{$id_user},NOW());";
	...
	if($(this).val() == '1'){
		...
		if($(this).val() == '2'){
			...
			if($(this).val() == '3'){
				...
				if($(this).val() == '4'){
					//pagina = "documento_resolucion.php?id="+id;	
				}else{													
					pagina = "";										
				}
			}
...
<?php include_once('layouts/header.php'); ?>
 <a href="quejas.php" class="btn btn-md btn-success" data-toggle="tooltip" title="Regresar">Regresar</a><br><br>
<div class="row">
    <div class="col-md-12">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?php if (!$datos['documento_promocion'] == "" && (strlen ($datos['documento_promocion']))>2  ) { ?>
                                            <a target="_blank" href="uploads/quejas/<?php echo $resultado . '/Acuerdos/' . $datos['documento_promocion']; ?>" title="Ver Acuerdo">
