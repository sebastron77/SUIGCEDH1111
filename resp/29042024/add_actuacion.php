...
if (isset($_POST['add_actuacion'])) {
    ...
    if (empty($errors)) {
        ...
        if ($move && $name != '') {
            ...
            $query .= "folio_actuacion,fecha_captura_acta,catalogo,descripcion,autoridades,autoridades_federales,peticion,adjunto,fecha_creacion_sistema,area_creacion,num_exp_origen,nombre_desaparecido,user_creador";
            $query .= ") VALUES (";
            $query .= " '{$folio}','{$fecha_captura_acta}','{$catalogo_actas}','{$descripcion}','{$autoridades}','{$autoridades_federales}','{$peticion}','{$name}','{$fecha_creacion_sistema}','{$area}','{$num_exp_origen}','{$nombre_desaparecido}','{$id_user}'";
            $query .= ")";
            ...
            $query = "INSERT INTO actuaciones (";
            $query .= "folio_actuacion,fecha_captura_acta,catalogo,descripcion,autoridades,autoridades_federales,peticion,fecha_creacion_sistema,area_creacion,num_exp_origen,user_creador";
            $query .= ") VALUES (";
            $query .= " '{$folio}','{$fecha_captura_acta}','{$catalogo_actas}','{$descripcion}','{$autoridades}','{$autoridades_federales}','{$peticion}','{$fecha_creacion_sistema}','{$area}','{$num_exp_origen}','{$id_user}'";
            $query .= ")";
