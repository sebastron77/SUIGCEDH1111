...
<div class="row">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form method="post" action="add_capacitacion.php?a=<?php echo $area_informe?>" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-2">
				...
				<div class="row">				 
					 <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number"  class="form-control" max="10000" name="asistentes_10" value="0" >
                        </div>
                    </div>
					<div class="col-md-3">
                        <div class="form-group">
                            <label for="no_asistentes">De 12 a 17 años</label>
                            <input type="number"  class="form-control" max="10000" name="asistentes_20" value="0" >
                        </div>
                    </div>
					<div class="col-md-3">
                        <div class="form-group">
                            <label for="no_asistentes">De 18 a 30 años</label>
                            <input type="number"  class="form-control" max="10000" name="asistentes_30" value="0" >
                        </div>
                    </div>
					<div class="col-md-3">
                        <div class="form-group">
                            <label for="no_asistentes">De 31 a 40 años</label>
                            <input type="number"  class="form-control" max="10000" name="asistentes_40" value="0" >
                        </div>
                    </div>
					...
					<div class="row">				 
					 <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number"  class="form-control" max="10000" name="asistentes_50" value="0" >
                        </div>
                    </div>
					<div class="col-md-3">
                        <div class="form-group">
                            <label for="no_asistentes">De 51 a 60 años</label>
                            <input type="number"  class="form-control" max="10000" name="asistentes_60" value="0" >
                        </div>
                    </div>
					<div class="col-md-3">
                        <div class="form-group">
                            <label for="no_asistentes">60 o más</label>
                            <input type="number"  class="form-control" max="10000" name="asistentes_70" value="0" >
                        </div>
                    </div>
					<div class="col-md-3">
                        <div class="form-group">
                            <label for="no_asistentes">Sin Dato</label>
                            <input type="number"  class="form-control" max="10000" name="asistentes_80" value="0" >
                        </div>
                    </div>
				</div>
