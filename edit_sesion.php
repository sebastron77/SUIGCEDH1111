...
if (isset($_POST['edit_sesion'])) {
    ...
    $sql = "UPDATE sesiones SET id_paciente='$id_paciente', fecha_atencion='{$fecha_atencion}', estatus='{$estatus}', nota_sesion='{$nota_sesion}', atendio='{$atendio}', no_sesion='{$no_sesion}',id_indicadores_pat='{$id_indicadores_pat}' ";
