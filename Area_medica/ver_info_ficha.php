...
$a_ficha = find_by_ficha((int)$_GET['id']);
                ...
                <table class="table table-bordered table-striped">
                    <thead class="thead-purple">
                        <tr style="height: 10px;" >
                            ...
                            <th  style="width: 4%;">Función</th>
                            <th  style="width: 3%;">No. Queja</th>
                ...
                <table class="table table-bordered table-striped">
                    <thead class="thead-purple">
                        <tr style="height: 10px;" >
                            ...
                            <th  style="width: 2%">Fecha de Intervención</th>
                            ...
                            <th  style="width: 7%;">Clave del documento</th>
