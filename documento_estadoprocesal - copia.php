...
//$estadoProcesal_act = $Procesal_act['descripcion'];
				...
				<br>
                    <div class="col-md-2">
                        <div class="form-group">
							<label for="procesal">Estado Procesal Actual: &nbsp;&nbsp;<span style="color:red;font-weight:bold"><?php echo $e_detalle['estado_procesal']; ?></span></label>
						</div >
					</div >
                </div >
                <div class="row">
