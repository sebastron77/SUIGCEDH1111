...
$nombre_disenio =find_descripcion_id('cat_tipo_disenios', $disenios['id_cat_tipo_disenios'], 'id_cat_tipo_disenios');
$user = current_user();
...
if ($nivel_user == 7 || $nivel_user == 53) {
	insertAccion($user['id_user'], '"' . $user['username'] . '" Visualizo la Información de '.$page_title.' . Folio:'.$disenios['folio'], 5);   
}
